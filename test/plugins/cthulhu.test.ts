...
test('CBR(70,30) 1%', () => {
  let randMock = new RandomMock('1/100');
  const input = 'CBR(70,30)'
  const expected = '1d100<=70,30 ＞ 1[決定的成功/スペシャル,決定的成功/スペシャル] ＞ 成功'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
...
test('CBR(25,20) 1%', () => {
  let randMock = new RandomMock('1/100');
  const input = 'CBR(25,20)'
  const expected = '1d100<=25,20 ＞ 1[決定的成功/スペシャル,決定的成功/スペシャル] ＞ 成功'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
...
test('1D100>=(68+12)', () => {
  let randMock = new RandomMock('11/100');
  const input = '1D100>=(68+12)'
  const expected = '1D100>=80 ＞ 11 ＞ 失敗'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
...
test('CBRB(70,30) (5%)', () => {
  let randMock = new RandomMock('5/100');
  const input = 'CBRB(70,30)'
  const expected = '1d100<=70,30 ＞ 5[決定的成功/スペシャル,決定的成功/スペシャル] ＞ 成功'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
...
test('CBRB(25,20) (5%)', () => {
  ...
  const expected = '1d100<=25,20 ＞ 5[決定的成功/スペシャル,決定的成功] ＞ 成功'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
...
test('CBR(10,80) (1%)', () => {
  let randMock = new RandomMock('1/100');
  const input = 'CBR(10,80)'
  const expected = '1d100<=10,80 ＞ 1[決定的成功/スペシャル,決定的成功/スペシャル] ＞ 成功'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
...
test('CBRB(10,80) (5%)', () => {
  ...
  const expected = '1d100<=10,80 ＞ 5[決定的成功,決定的成功/スペシャル] ＞ 成功'
  const res = plugin.roll(randMock, input, new Lexer(input).lex());
  expect(getFullText(res)).toBe(expected);
});
